...
namespace Tellann
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Tellann";
        public static string heroName = characterName;

        public static string subclassName = "Exalted"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Tellann, the Exalted.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Tellann",
                _contentFolder: "Tellann",
